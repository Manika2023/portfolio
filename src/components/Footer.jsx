  ...
  return (
    <footer className="bg-gray-600 text-gray-200 py-4">
      <div className="container mx-auto text-center">
        <div className="">
          <a href="https://github.com/Manika2023" target="_blank" rel="noopener noreferrer" className="mx-2">
          ...
          <a href="https://www.linkedin.com/in/manika-kumari-116134260?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noopener noreferrer" className="mx-2">
